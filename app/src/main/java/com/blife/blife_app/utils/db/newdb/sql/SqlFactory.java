...
import com.blife.blife_app.utils.db.newdb.table.ColumnUtils;
...
public class SqlFactory {
	 ...
	 * "ByZhao").or("age", "=", 1).orderBy("age", true) 表示<br>
	 ...
	 * Object[] { "ByZhao", 2 }).where( "age", "=", 1) 表示<br>
	 * UPDATE Person SET name='ByZhao',age=2 where age = 1<br>
	 * 
	 * @param tableClass
	 * @param updateColumnNames
	 *            要更新的字段
	 ...
	 * <br>
	 * 例子：SqlFactory.delete(Person.class).where("name", "=", "ByZhao") 表示<br>
	 * delete from Person where name = 'ByZhao'<br>
	 * 
	 * @param tableClass
	 * @return
	 */
