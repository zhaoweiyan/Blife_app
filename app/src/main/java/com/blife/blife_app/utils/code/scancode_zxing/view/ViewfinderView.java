...
package com.blife.blife_app.utils.code.scancode_zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        maskColor = Intents.viewfinder_mask;
        resultColor = Intents.result_view;
        laserColor = Intents.viewfinder_laser;
        resultPointColor = Intents.possible_result_points;
        statusColor = Intents.status_text;
        scannerAlpha = 0;
