 ...
 */
public class API_MyadvFinished implements InterfaceAPIData {

    private int limit;
    private int offset;
    String API = Constants.HTTP + "/advertisement/list";
    public static String TAG = "tag_get_isfinish_advertisement_list";
    private String token;

    public API_MyadvFinished(String accessToken, int offset, int limit) {
