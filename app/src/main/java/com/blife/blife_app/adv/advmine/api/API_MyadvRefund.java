 ...
 */
public class API_MyadvRefund implements InterfaceAPIData {

    private int limit;
    private int offset;
    String API = Constants.HTTP + "/advertisement/list";
    public static String TAG = "tag_get_refund_advertisement_list";
    private String token;

    public API_MyadvRefund(String accessToken, int offset, int limit) {
