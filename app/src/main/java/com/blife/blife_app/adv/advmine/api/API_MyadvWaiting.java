 ...
 */
public class API_MyadvWaiting implements InterfaceAPIData {

    private int limit;
    private int offset;
    String API = Constants.HTTP + "/advertisement/list";
    public static String TAG = "tag_get_waiting_advertisement_list";
    private String token;

    public API_MyadvWaiting(String accessToken, int offset, int limit) {
