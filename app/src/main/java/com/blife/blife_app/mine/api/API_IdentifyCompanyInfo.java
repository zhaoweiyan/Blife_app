 ...
 */
public class API_IdentifyCompanyInfo implements InterfaceAPIData {

    private String API = Constants.HTTP + "/company/info";
    public static String TAG = "tag_put_company_info";

    private String ACCESSTOKEN, Json;

    public API_IdentifyCompanyInfo(String ACCESSTOKEN, String json) {
        Json = json;
