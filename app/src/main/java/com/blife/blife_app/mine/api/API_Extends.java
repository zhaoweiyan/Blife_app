 ...
 */
public class API_Extends implements InterfaceAPIData {
    private String token;
    private String API = Constants.HTTP + "/promotion/merchant";
    public static String TAG = "get_promotion_merchant";

    public API_Extends(String access_token) {
