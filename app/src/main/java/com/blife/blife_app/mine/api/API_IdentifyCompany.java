 ...
 */
public class API_IdentifyCompany implements InterfaceAPIData {
    String API = Constants.HTTP + "/company/identification";
    public static String TAG = "tag_post_company_identification";
    private String token;

    public API_IdentifyCompany(String accessToken) {
